...
def process_color_in_images(originalImage, testingImage):
    print("processing color in images")

    encoded_images = [originalImage, testingImage]
    ...
    color_difference = difference_in_colors_analyze(description_image_1_color, description_image_2_color, encoded_images[0],
                                                    encoded_images[1])
...
# Function to analyze differences in layout
...
# Analyze each image
def process_layout_in_images(originalImage, testingImage):
...
# Function to analyze differences in text
...
# Analyze each image for text
def process_text_in_images(originalImage, testingImage):
